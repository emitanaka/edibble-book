...
The experimental planning in this book is supported by the `edibble` R-package and its extensions. The `edibble` system is based on the grammar of experimental designs in [Chapter -@sec-grammar]. To get started with using the system, you need to first load the package: 
