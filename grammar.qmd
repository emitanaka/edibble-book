...
There are two types of relationships in the system: the higher-order links between the factor nodes in the head system and the lower-order links between the level nodes in the root system. The user explicitly defines the higher-order links and depending on how it is defined, the system links the lower-order links between the root nodes with some constraint as prescribed by their explicit role and other user input.  
...
Higher-order links between factor nodes in the head system must be established before the lower-order links between the corresponding level nodes in the root system.
